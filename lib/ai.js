...
const move = exports.move = (state, grabHouse) => {
  ...
  while (grabSeed > 0) {
    ...
    // jika posisi sekarang == house player dan seed belum habis --> continue
    if (currentPos === PLAYER_POINT_INDEX) {
      currentPos += 1;
      continue;
    }

    // jika posisi sekarang != house enemy && seed = 1 &&  statePlayer[posisi] != 0
  ...
  // jika playerState taruh seed di HousePoint, maka bisa lanjut lagi...
...
// check player's if last seeds in house
function lastPoint(){
